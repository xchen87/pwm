...
Not yet used (arrive with later slices): model provider credentials (Slice 1), Google OAuth client and token-encryption key (Slice 4), push credentials (Slice 5). None of these will ever be `EXPO_PUBLIC_`.
